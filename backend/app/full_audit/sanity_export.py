...
async def build_sanity_export(audit: FullAuditData) -> dict:
    ...
    return {
        ...
        "ownedChannels": {
            ...
            "welcomeFlowObserved": oc.welcome_flow_observed,
            "abandonedCartFlowObserved": oc.abandoned_cart_flow_observed,
            "postPurchaseFlowObserved": oc.post_purchase_flow_observed,
            "winBackFlowObserved": oc.win_back_flow_observed,
            "estEmailRevenuePercent": oc.est_email_revenue_percent,
            "benchmarkEmailRevenuePercent": oc.benchmark_email_revenue_percent,
